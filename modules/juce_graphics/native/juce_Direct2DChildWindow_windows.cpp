...
public:
    ...
    {
        return messageThread.isThreadRunning();
    }
...
private:
    ...
    static LRESULT CALLBACK windowProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
    {
        ...
        switch (message)
        {
            ...
            case WM_PAINT:
            case WM_NCPAINT: direct2d::UpdateRegion::forwardInvalidRegionToParent (hwnd); return 0;

            case WM_WINDOWPOSCHANGED: return 0;
    ...
    {
        MessageThread (ChildWindowThread* const owner_)
            : Thread ("Direct2DMessageThread"),
              owner (owner_)
        {
        }
        ...
        HWND createChildWindow (HWND parentHwnd)
        {
            ...
            // Specify WS_DISABLED to pass input events to parent window
            HMODULE moduleHandle = (HMODULE) Process::getCurrentModuleInstanceHandle();
